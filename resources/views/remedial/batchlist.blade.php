...
<ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Remedial Attendance</li>
        </ol>
@endsection
                ...
                <div class="card-body">
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <td> 
                                <div>
                                    <button type="button" class="btn btn-outline-primary btn-sm" onclick="window.location.href='{{ url('/remedial/'.$eight->id.'/'.$standard.'/newattendance') }}'">Add</button>
                                    <button type="button" class="btn btn-outline-danger btn-sm" onclick="window.location.href='{{ url('/remedial/'.$eight->id.'/'.$standard.'/listattendance') }}'">List</button>
                                    <button type="button" class="btn btn-outline-success btn-sm" onclick="window.location.href='{{ url('/remedial/'.$eight->id.'/'.$standard.'/summaryreport') }}'">Summary Report</button>
                                </div>
                            </td>
                            </tr>
                            @endforeach
