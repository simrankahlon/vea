                ...
                <div class="card-body">
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <td> 
                                <div> 
                                    <button type="button" class="btn btn-outline-primary btn-sm" onclick="window.location.href='{{ url('/marks/'.$eight->id.'/'.$standard.'/newmarks') }}'">Add</button>
                                    <button type="button" class="btn btn-outline-danger btn-sm" onclick="window.location.href='{{ url('/marks/'.$eight->id.'/'.$standard.'/listmarks') }}'">List</button>
                                    <button type="button" class="btn btn-outline-success btn-sm" onclick="window.location.href='{{ url('/marks/'.$eight->id.'/'.$standard.'/summaryreport') }}'">Summary Report</button>
                                </div>
                            </td>
                            </tr>
                            @endforeach
