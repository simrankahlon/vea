                        ...
                        <tbody>
                            ...
                            <td> 
                                <div> 
                                    ...
                                    <button type="button" class="btn btn-outline-success btn-sm" onclick="window.location.href='{{ url('/attendance/'.$nine->id.'/'.$standard1.'/listattendance') }}'">List</button>
                        ...
                        <tbody>
                            ...
                            <td> 
                                <div> 
                                    ...
                                    <button type="button" class="btn btn-outline-success btn-sm" onclick="window.location.href='{{ url('/attendance/'.$ten->id.'/'.$standard2.'/listattendance') }}'">List</button>
