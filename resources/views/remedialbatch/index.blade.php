...
<ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Remedial Batch</li>
            <li class="breadcrumb-menu">
                <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                    <a class="btn btn-secondary" href="{{ url('/remedialbatch/create') }}"><i class="icon-plus"></i> &nbsp;Create Remedial Batch </a>
                </div>
            </li>
        </ol>
@endsection
    ...
    <div class="card-block">
        <div class="row">
            ...
            <div class="col-xs-6"> 
                ...
                @endphp
                <form action="{{ url('/remedialbatch/filters') }}" method="get" id="batch_filter">
                    {{ csrf_field() }}
            ...
            <div class="col-xs-5">
                ...
                @endphp
                <form action="{{ url('/remedialbatch/search') }}" method="get" id="frmserch">
                    {{ csrf_field() }}
                    <!--  <div class="form-control"> -->
                                            ...
                                            <tbody id="tasks-list">
                                             @foreach ($batch as $bat)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div>
                                                            <a href="{{ url('/remedialbatch/'.$bat->id.'/edit') }}">{{$bat->batchname }}</a>
                                                        </div>
                                                    </td>
                                                    <td>
                                                    @php
                                                   ...
                                                   <div class="float-xs-right"> 
                                                    <button type="button" class="btn btn-outline-primary btn-sm" onclick="window.location.href='{{ url('/remedialbatch/'.$bat->id.'/edit') }}'">Edit</button>
                                                    <button type="button" class="btn btn-outline-danger btn-sm" onclick="javascript:confirmDelete('{{ url('/remedialbatch/'.$bat->id.'/delete') }}')" disabled="">Delete</button>
                                                    </div>
                                                </td>
                                                </tr>
                                            @endforeach
