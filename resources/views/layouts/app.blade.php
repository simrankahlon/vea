    ...
    <header class="navbar">
        <div class="container-fluid">
            ...
            <ul class="nav navbar-nav hidden-md-down">
                ...
                <li class="nav-item px-1">
                    <strong style="color:#004080">{{$branch}}</strong>
                </li>
                <li class="nav-item px-1">
                    <strong style="color:#004080">{{$fromyear}} - {{$toyear}}</strong>
                </li>
            ...
            <ul class="nav navbar-nav float-xs-right">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        ...
                        <a class="dropdown-item" href="{{url('/switchbranchandyear')}}"><i class="icon-directions"></i>Switch Branch and Academic Year</a>
