...
<div class="card">
    <div class="card-block">
        <div class="row">
            <form action="{{ url('/waiting_list/filters') }}" method="get" id="enquiry_filter">
                    {{ csrf_field() }}
            <div class="col-xs-5">
                @php
            ...
            <div class="col-xs-5">
                ...
                @endphp
                <form action="{{ url('/waiting_list/search') }}" method="get" id="frmserch">
                    {{ csrf_field() }}
                    <!--  <div class="form-control"> -->
                    <input name ="searchtxt" type="text" class="form-control left" id="searchtxt" placeholder="Search Waiting List" value="{{ $search }}" > <span style="color:red">{{ $errors->first('searchtxt') }}</span>
                    </div>
